...
st.markdown("""
    ...
    .stMarkdown > div > strong:nth-child(1) + br + br + div { /* Apuntando al div que contiene las estadísticas */
...
with st.container():
    ...
    st.image("https://placehold.co/800x100/1C3F93/FFFFFF?text=VISOR+MONITOREO", use_container_width=True) # 
# --- VISOR PRINCIPAL ---
...
"
I will now adjust the styling of the Canvas to use a lighter blue as the main background and modify other elements to fit the brand guidelines. I'll also address your question about the sidebar behavior.
...
# --- Cargar datos principales ---
# Se utiliza la URL de GitHub proporcionada directamente
url_zip_monitoreo = "[https://raw.githubusercontent.com/lmiguerrero/BOT/main/Pol_Monitoreo.zip](https://raw.githubusercontent.com/lmiguerrero/BOT/main/Pol_Monitoreo.zip)"
...
with st.container():
    # Placeholder de imagen con colores de la marca Bogotá
    st.image("[https://placehold.co/800x100/1C3F93/FFFFFF?text=VISOR+MONITOREO](https://placehold.co/800x100/1C3F93/FFFFFF?text=VISOR+MONITOREO)", use_container_width=True) # 
# --- VISOR PRINCIPAL ---
if gdf_total is None:
    st.warning("⚠️ No se pudieron cargar los datos geográficos principales. El visor no puede funcionar sin ellos.")
    st.stop() 
